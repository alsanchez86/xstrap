...
<header id="header" class="header">
    ...
    <img class="img-responsive img-responsive-center" src="./images/xstrap-logo.png" alt="XStrap" title="XStrap">
    ...
    <div class="designed-by-header">
        <i>designed by</i>
        <img src="./images/oxe-logo.png" alt="designed by Ximdex" title="designed by Ximdex">
    </div>
</header>
...
<!-- COMPONENTS -->
<!-- dropdowns -->
<script src="./xstrap/dropdowns/js/dropdown.js"></script>
<!-- scrollspy -->
<script src="./xstrap/scrollspy/js/scrollspy.js"></script>
<!-- affix -->
<script src="./xstrap/affix/js/affix.js"></script>
<!-- tooltip -->
<script src="./xstrap/tooltips/js/tooltip.js"></script>
<!-- popover -->
<script src="./xstrap/popovers/js/popover.js"></script>

<!-- forms -->
<script src="./xstrap/forms/js/forms.js"></script>
<!-- datepicker -->
<script src="./xstrap/datepicker/js/datepicker.js"></script>
<!-- typehead -->
<script src="./xstrap/typeahead/js/typeahead.js"></script>
