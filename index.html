...
<div class="body-container container">
    ...
    <div class="row">
        <div class="col-xs-3">
            <ol>
                <li>Asteric: <span class="glyphicon glyphicon-asterisk"></span></li>
                <li>Asteric: <span class="glyphicon glyphicon-asterisk"></span></li>
                <li>Asteric: <span class="glyphicon glyphicon-asterisk"></span></li>
                <li>Asteric: <span class="glyphicon glyphicon-asterisk"></span></li>
                <li>Asteric: <span class="glyphicon glyphicon-asterisk"></span></li>
    ...
    <div class="route-job">
        ...
        <ul class="list">
            <li class="text-highlight">ACTUAL => Boostrap.min.css + (variables.less + mixins + base.less). <i>[Técnica del parche]</i></li>
            <li>XSTRAP => Boostrap.css (variables.less de bootstrap (modificadas y ampliadas al cruzarlas con variables.less mio) + componentes .less (modificados y ampliados al cruzarlo con base.less mio). Los mixins de bootstrap también serán modificados y ampliados al cruzarlos con el mío, pero también se usarán a la hora de escribir el main.less, media-xs.less, media-md.less, ...</li>
        </ul>
        ...
        <p><strong>1) Terminar de crear el base.less filtrando todos los componentes de bootstrap y creando sus correspondientes variables.less para modificarlos, y modificando los mixins.less según sea conveniente.</strong></p>
        ...
        <p><strong>2) Fusión de base.less con los componentes de bootstrap directamente modificando el código fuente de este pre-compilación. Fusión de variables.less. Fusión de Mixins.less.</strong></p>
        ...
        <p class="text-lowlight">
            <i>
                ...
                <br>
                Ver <a class="blank" href="http://getbootstrap.com/css/#less" target="_blank">variables.less</a> de Bootstrap pre-compilado.
            </i>
        </p>
    </div>
</div>
